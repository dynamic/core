$(document).ready(function() {
    ...
    $(".header li.social a").on('click', function(e) {
        ...
        ga('send', 'event', 'Header Social Icon', 'Click', $(this).attr('href'));
    });
    ...
    $(".grid a img").on('click', function(e) {
        ...
        ga('send', 'event', 'Spiff Image', 'Click', $(this).attr('href'));
    });
    ...
    $(".grid h4 a").on('click', function(e) {
        ...
        ga('send', 'event', 'Spiff Header Link', 'Click', $(this).attr('href'));
    });
    ...
    $(".grid a.learnMore").on('click', function(e) {
        ...
        ga('send', 'event', 'Spiff Button/Link', 'Click', $(this).attr('href'));
    });
    ...
    $(".flexslider a img").on('click', function(e) {
        ...
        ga('send', 'event', 'Slider Image', 'Click', $(this).attr('href'));
    });
    $(".flexslider a.flex-button").on('click', function(e) {
        ...
        ga('send', 'event', 'Slider Button', 'Click', $(this).attr('href'));
    });
    ...
    $("#Form_Form_action_process").on('click', function(e) {
        ...
        ga('send', 'event', 'Form Submit Button', 'Click', 'Form Submission');
    });
    ...
    $("a.PhoneTracking").on('click', function(e) {
        ...
        ga('send', 'event', 'Form Submit Button', 'Click', 'Phone Number');
    });
    ...
    $("#ChildEvent a img").on('click', function(e) {
        ...
        ga('send', 'event', 'Child List Page Image', 'Click', $(this).attr('href'));
    });
    ...
    $("#ChildEvent h4 a").on('click', function(e) {
        ...
        ga('send', 'event', 'Child List Page Title Link', 'Click', $(this).attr('href'));
    });
    ...
    $("#ChildEvent a.learnMore").on('click', function(e) {
        ...
        ga('send', 'event', 'Child List Page button click', 'Click', $(this).attr('href'));
    });
    ...
    $(".blog-list a img").on('click', function(e) {
        ...
        ga('send', 'event', 'Blog Holder Image', 'Click', $(this).attr('href'));
    });
    ...
    $(".blog-list h4 a").on('click', function(e) {
        ...
        ga('send', 'event', 'Blog Holder Title Link', 'Click', $(this).attr('href'));
    });
    ...
    $(".blog-list a.readmore").on('click', function(e) {
        ...
        ga('send', 'event', 'Blog Holder button click', 'Click', $(this).attr('href'));
    });
